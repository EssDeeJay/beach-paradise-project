...
const Tickets = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/tickets' : `/category/tickets/${currentPage - 1}`
    const nextPage = `/category/tickets/${currentPage + 1}`
...
export const pageQuery = graphql` 
 query TicketsQuery ($skip: Int!, $limit: Int!) {
   allContentfulBlog(

...
const Directions = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/directions' : `/category/directions/${currentPage - 1}`
    const nextPage = `/category/directions/${currentPage + 1}`
...
export const pageQuery = graphql` 
 query DirectionsQuery ($skip: Int!, $limit: Int!) {
   allContentfulBlog(
